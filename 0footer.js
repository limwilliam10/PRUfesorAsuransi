let appFooter = `
    ...
    <head>
      ...
      <title>W&G PRUfesor Asuransi</title>
      ...
      <footer id="footer">
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-lg-4 col-md-3 footer-contact">
                <h3><span>PRU</span>fesor<br>Asuransi</h3><br>
                <p>
                  USTeams Prudential <br>
                  Mangga Dua Square<br>
                  Lantai 1 Blok A no. 46-56<br>
                  Jakarta Utara <br>
                  14420 <br>
                </p>
              </div>
        ...
        <div class="container py-4">
          ...
          <div class="social-links text-center text-md-end pt-3 pt-md-0">
            <a href="https://www.instagram.com/limwilliam10/" class="instagram"><i class="bx bxl-instagram"></i></a>
            <a href="https://www.linkedin.com/in/lim-william/" class="linkedin"><i class="bx bxl-linkedin"></i></a>
            <a href="https://wa.me/+6281218035252" class="whatsapp"><i class="bx bxl-whatsapp"></i></a>
            <a href="mailto:limwilliam.id@gmail.com" class="google-plus"><i class="bx bxl-google"></i></a>
            <a href="https://www.facebook.com/sherringford/" class="facebook"><i class="bx bxl-facebook"></i></a>
            <a href="https://twitter.com/LimWilliam_" class="twitter"><i class="bx bxl-twitter"></i></a>
          -->
          </div>
        </div>
      </footer>
